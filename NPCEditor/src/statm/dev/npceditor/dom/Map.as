package statm.dev.npceditor.dom
{
	...
	import statm.dev.npceditor.dom.item.ItemDefinitionList;
	import statm.dev.npceditor.dom.layers.BgLayer;
	import statm.dev.npceditor.dom.layers.Grids;
	import statm.dev.npceditor.dom.layers.Items;
	import statm.dev.npceditor.dom.objects.IconList;
	...
	public class Map extends DomNode
	{
		...
		private var _version : String = npceditor.VERSION;
		...
		{
			var result : XML = <map id={this.mapID} name={this.mapName} levelLimit={this.levelLimit} version={npceditor.VERSION}/>;
