package statm.dev.mapeditor.dom.brush
{
    ...
    public class Brush implements IXMLSerializable
    {
        ...
        public function readXML(xml:XML):void
        {
            ...
            else if (iconString == "eNrtzbENAAAIwzB+Zu/tfEEXR8rsmW6b5Hs2m81ms9lsNpvNZnftVgdQD1Pw" || iconString == "eNrtzTERADAIBEHEYgoDURJhuOCbvZmrtyrb9PvXs9lsNpvNZrPZbDY7a6dayz7kyQ==")
            {
