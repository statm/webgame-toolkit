...
// 常量
public static const DEFAULT_FRAME_RATE:int = 10;
...
private function resourceList_changeHandler(event:IndexChangeEvent):void
{
	...
	AppState.instance.primaryImageHeight = 340;
...
public function setDirection(direction:String):void
{
	...
	var selectedItemType:String = resourceList.selectedItem.type;
	
	if (AppState.instance.categoryMode != ResourceType.HERO)
	{
		return;
	}
